...
private slots:
    ...
    void on_PBNuevoMesa_clicked();

    void on_PBGuardarMesa_clicked();

    void on_PBCancelarMesa_clicked();

    void on_PBEditarMesa_clicked();

    void on_PBEliminarMesa_clicked();

    void on_LEBuscarMesa_textChanged(const QString &arg1);

    void on_LEIDMesa_textChanged(const QString &arg1);

    void on_PBBuscarMesa_clicked();
